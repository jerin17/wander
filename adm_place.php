...
<div class="container">
  <div class="row text-center" >
      <div class="col-md-offset-2 col-sm-offset-4" style="background: #2c3e50 ; color: white; border-radius: 10px" >
        <h1 style="color:#2ecc71;">PLACES</h1><br><br><br>
        <form action="city_session.php" method="POST">

        <label style="float:left; margin-left: 15px;">Place :</label><br>
        <select name="c_name" style="color: black; width:500px; font-size: 18px;" required>
        ...
        ?>
          ...
          <br><br><input type="submit" value="VIEW ALL PLACES" style="background:#2ecc71;color: white;border-radius: 5px;">
        </form><hr>
